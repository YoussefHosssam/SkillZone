...
//Branch Routes
const {getAllBranches , createBranch} = require (`${__dirname}/../controllers/branch/branchControllers.js`)
router.route('/:id/branches').get(getAllBranches).post(protect , restrictTo("centerAdmin" , "admin") , createBranch)
